...
namespace ServiceLayer.SERVICES.Repositories.Services
{
    public class PaymentRepository:GenericRepository<Payment> , IPaymentRepository
    {
        ...
        public PaymentRepository(ApplicationContext context, IOptions<StripeSettings> options, IMapper mapper):base(context)
        {
            _mapper = mapper;
            _context = context;
        }
        ...
        private async Task<Payment> CreatePayment(PaymentDto dto,User user)
        {
        ...
        public async Task<ResponseDto> CreateCheckoutSession(PaymentDto dto, User user)
        {
