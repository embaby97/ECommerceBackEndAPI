...
namespace ServiceLayer.SERVICES.Repositories.Services
{
    ...
    //    public MailRepository(ApplicationContext context,IOptions<EmailSettings> setting):base(context)
    //    {
    ...
    //    public async Task SendResetPasswordEmailAsync(User user, string subject)
    //    {
